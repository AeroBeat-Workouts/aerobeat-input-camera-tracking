...
- Captured: `2026-06-15 23:21:50`
- Elapsed: `11270ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-straight-only-2026-06-15/captures/run_in_place_negative_control/proving.png`
...
Best class / score / threshold: straight_left / 0.815 / 0.700
Result class / emitted event: straight_left / punch_left
Debug flags: show_scores=true show_event_gate_state=true
Class scores: {hook_left=0.000, hook_right=0.000, straight_left=0.815, straight_right=0.359, uppercut_left=0.000, uppercut_right=0.000}
Gate reason / hold / cooldown / active event: emitted / 100ms / 250ms / straight_left
...
Live wrist separation: x=0.110 y=0.025
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.131 R=0.156
...
Live height ratio: 0.911 (lowered)
Squat depth: 0.089
Torso height live / baseline: 0.319 / 0.350
...
Live offsets: head=-0.073 hip=-0.065 relative=-0.009
Head drop ratio: 0.000 (ready=false)

Tracker hand truth
------------------
Frame: 3457  source=video_file  playback=paused 0:00/0:05
