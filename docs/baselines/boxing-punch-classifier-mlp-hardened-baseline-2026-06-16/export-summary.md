...
- Exported at: `2026-06-16T21:40:26.418732+00:00`
...
- Window shape: `8 frames x 16 features/frame`
- Samples: **96**
...
- No-punch contexts: `{"non_punch_fixture_background": 36, "punch_fixture_background": 12, "transition_after_punch": 4, "transition_before_punch": 20}`

## Alignment summary

- Capture time-origin offset ms (min/mean/max): **1056 / 1106.4 / 1136**
- Window start alignment error ms (min/mean/max): **0 / 16.0 / 58**
- Window end alignment error ms (min/mean/max): **0 / 18.2 / 143**

- `hook_left_fixture` offset=1080ms start_err=13.6ms end_err=13.2ms samples=11
- `hook_right_fixture` offset=1131ms start_err=10.7ms end_err=16.4ms samples=10
- `knee_left_fixture` offset=1133ms start_err=11.0ms end_err=7.0ms samples=3
- `knee_right_fixture` offset=1130ms start_err=9.0ms end_err=16.7ms samples=3
- `leg_lift_left_fixture` offset=1081ms start_err=18.2ms end_err=9.8ms samples=4
- `leg_lift_right_fixture` offset=1082ms start_err=27.0ms end_err=28.0ms samples=3
- `run_in_place_fixture` offset=1129ms start_err=27.7ms end_err=21.0ms samples=3
- `sidestep_left_fixture` offset=1083ms start_err=9.0ms end_err=9.7ms samples=3
- `sidestep_right_fixture` offset=1087ms start_err=10.7ms end_err=23.0ms samples=3
- `squat_fixture` offset=1079ms start_err=10.5ms end_err=39.2ms samples=4
- `stance_transition_fixture` offset=1133ms start_err=13.8ms end_err=6.8ms samples=4
- `straight_left_fixture` offset=1056ms start_err=18.8ms end_err=14.1ms samples=10
- `straight_right_fixture` offset=1131ms start_err=10.0ms end_err=13.7ms samples=10
- `uppercut_left_fixture` offset=1136ms start_err=23.2ms end_err=21.3ms samples=10
- `uppercut_right_fixture` offset=1130ms start_err=18.9ms end_err=27.0ms samples=9
- `weave_left_fixture` offset=1088ms start_err=24.0ms end_err=18.0ms samples=3
- `weave_right_fixture` offset=1084ms start_err=21.3ms end_err=35.7ms samples=3
...
- Retained feature snapshots: **217**
- Annotated punch windows: **4**
- Background no-punch candidates: **13**
- Transition no-punch candidates: **8**
