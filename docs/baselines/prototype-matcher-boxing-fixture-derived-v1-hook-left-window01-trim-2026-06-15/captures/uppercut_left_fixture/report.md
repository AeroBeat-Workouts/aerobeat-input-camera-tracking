...
- Captured: `2026-06-15 19:56:58`
- Elapsed: `11346ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-hook-left-window01-trim-2026-06-15/captures/uppercut_left_fixture/proving.png`
...
Best class / score / threshold: uppercut_left / 0.936 / 0.700
Result class / emitted event: uppercut_left / none
Debug flags: show_scores=true show_event_gate_state=true
Class scores: {hook_left=0.620, hook_right=0.796, straight_left=0.765, straight_right=0.683, uppercut_left=0.936, uppercut_right=0.860}
...
Live wrist separation: x=0.098 y=0.009
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.118 R=0.132
...
Live height ratio: 1.042 (standing)
Squat depth: 0.000
Torso height live / baseline: 0.381 / 0.366
...
Live offsets: head=-0.135 hip=0.065 relative=-0.200
Head drop ratio: 0.000 (ready=false)

Tracker hand truth
------------------
Frame: 3317  source=video_file  playback=paused 0:00/0:08
