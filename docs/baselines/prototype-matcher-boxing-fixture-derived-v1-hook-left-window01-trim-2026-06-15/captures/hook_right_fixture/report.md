...
- Captured: `2026-06-15 19:56:44`
- Elapsed: `11364ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-hook-left-window01-trim-2026-06-15/captures/hook_right_fixture/proving.png`
...
Best class / score / threshold: hook_right / 0.967 / 0.700
Result class / emitted event: hook_right / none
Debug flags: show_scores=true show_event_gate_state=true
Class scores: {hook_left=0.728, hook_right=0.967, straight_left=0.792, straight_right=0.695, uppercut_left=0.812, uppercut_right=0.893}
...
Live wrist separation: x=0.086 y=0.021
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.101 R=0.081
...
Live height ratio: 1.016 (standing)
Squat depth: 0.000
Torso height live / baseline: 0.333 / 0.328
...
Live offsets: head=-0.158 hip=0.048 relative=-0.206
Head drop ratio: 0.011 (ready=false)

Tracker hand truth
------------------
Frame: 3428  source=video_file  playback=paused 0:00/0:08
