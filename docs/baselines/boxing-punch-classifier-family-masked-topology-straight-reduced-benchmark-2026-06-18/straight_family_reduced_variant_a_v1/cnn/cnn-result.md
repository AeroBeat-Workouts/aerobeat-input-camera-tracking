...
- Trained at: `2026-06-18T16:17:29.452084+00:00`
- Dataset: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/boxing-punch-classifier-family-masked-topology-straight-reduced-benchmark-2026-06-18/straight_family_reduced_variant_a_v1/export/dataset.json`
- MLP baseline: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/boxing-punch-classifier-family-masked-topology-straight-reduced-benchmark-2026-06-18/straight_family_reduced_variant_a_v1/mlp/mlp-result.json`
- Split strategy: `chronological_holdout_v1`
- Model shape: `8x18 -> conv1d(18->12, k=3, same) -> relu -> conv1d(12->12, k=3, same) -> relu -> flatten(96) -> logits(3)`
- Epochs: **500**
- Learning rate: **0.02**
- Weight decay: **0.0005**
...
- Temporal MLP accuracy: **0.960**
- Temporal MLP macro F1: **0.881**
