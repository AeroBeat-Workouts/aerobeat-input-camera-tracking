...
- Captured: `2026-06-16 00:17:46`
- Elapsed: `11303ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-straight-only-xy-only-2026-06-15/captures/run_in_place_negative_control/proving.png`
...
Class scores: {}
Gate reason / hold / cooldown / active event: step_wait / 100ms / 250ms / straight_left
...
Live wrist separation: x=0.110 y=0.017
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.133 R=0.152
...
Live height ratio: 0.919 (lowered)
Squat depth: 0.081
...
Live offsets: head=-0.067 hip=-0.084 relative=0.017
Head drop ratio: 0.000 (ready=false)

Tracker hand truth
------------------
Frame: 3524  source=video_file  playback=paused 0:00/0:05
