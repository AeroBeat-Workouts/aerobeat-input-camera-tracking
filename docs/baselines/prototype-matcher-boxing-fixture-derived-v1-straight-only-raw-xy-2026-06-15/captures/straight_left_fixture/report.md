...
- Captured: `2026-06-16 00:55:05`
- Elapsed: `11298ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-straight-only-raw-xy-2026-06-15/captures/straight_left_fixture/proving.png`
...
Prototype library ID: boxing_side_aware_fixture_derived_v1_straight_only (loaded=true)
Best class / score / threshold: straight_left / 0.990 / 0.700
Result class / emitted event: straight_left / none
Debug flags: show_scores=true show_event_gate_state=true
Class scores: {hook_left=0.000, hook_right=0.000, straight_left=0.990, straight_right=0.947, uppercut_left=0.000, uppercut_right=0.000}
Gate reason / hold / cooldown / active event: emit_cooldown_active / 0ms / 150ms / no_punch
...
Live wrist separation: x=0.134 y=0.033
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.110 R=0.079
...
Live height ratio: 0.904 (transition)
Squat depth: 0.096
Torso height live / baseline: 0.338 / 0.374
...
Live offsets: head=-0.037 hip=0.091 relative=-0.127
Head drop ratio: 0.047 (ready=false)

Tracker hand truth
------------------
Frame: 3482  source=video_file  playback=paused 0:00/0:06
