...
- Captured: `2026-06-16 00:55:19`
- Elapsed: `11264ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-straight-only-raw-xy-2026-06-15/captures/straight_right_fixture/proving.png`
...
Live wrist separation: x=0.122 y=0.014
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.091 R=0.075
...
Live height ratio: 0.996 (standing)
Squat depth: 0.004
Torso height live / baseline: 0.450 / 0.452
...
Live offsets: head=-0.020 hip=-0.019 relative=-0.000
Head drop ratio: 0.021 (ready=false)

Tracker hand truth
------------------
Frame: 3757  source=video_file  playback=paused 0:00/0:06
