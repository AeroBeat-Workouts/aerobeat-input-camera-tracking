...
- Captured: `2026-06-16 14:36:19`
- Elapsed: `10849ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-straight-only-2026-06-16/captures/straight_left_fixture/proving.png`
...
Class scores: {}
Gate reason / hold / cooldown / active event: step_wait / 100ms / 250ms / straight_right
...
Live wrist separation: x=0.101 y=0.174
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.117 R=0.084
...
Live height ratio: 0.989 (standing)
Squat depth: 0.011
...
Live offsets: head=-0.187 hip=0.216 relative=-0.403
Head drop ratio: 0.081 (ready=true)

Tracker hand truth
------------------
Frame: 4714  source=video_file  playback=paused 0:00/0:06
