...
- Captured: `2026-06-16 14:36:32`
- Elapsed: `10925ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-straight-only-2026-06-16/captures/straight_right_fixture/proving.png`
...
Class scores: {}
Gate reason / hold / cooldown / active event: step_wait / 0ms / 125ms / no_punch
...
Live wrist separation: x=0.120 y=0.018
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.092 R=0.080
...
Squat depth: 0.007
Torso height live / baseline: 0.457 / 0.460
...
Live offsets: head=0.044 hip=-0.008 relative=0.052
Head drop ratio: 0.004 (ready=false)

Tracker hand truth
------------------
Frame: 4437  source=video_file  playback=paused 0:00/0:06
