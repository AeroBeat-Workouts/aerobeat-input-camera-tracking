...
- Captured: `2026-06-16 14:36:46`
- Elapsed: `11343ms`
- Screenshot: `/home/derrick/.openclaw/workspace/projects/aerobeat/aerobeat-input-camera-tracking/docs/baselines/prototype-matcher-boxing-fixture-derived-v1-straight-only-2026-06-16/captures/run_in_place_negative_control/proving.png`
...
Class scores: {}
Gate reason / hold / cooldown / active event: step_wait / 0ms / 150ms / no_punch
...
Live wrist separation: x=0.113 y=0.017
Wrists above elbows: L=true R=true
Wrist-to-nose distances: L=0.139 R=0.151
...
Live height ratio: 0.907 (transition)
Squat depth: 0.093
Torso height live / baseline: 0.314 / 0.346
...
Live offsets: head=-0.121 hip=-0.153 relative=0.031
Head drop ratio: 0.017 (ready=false)

Tracker hand truth
------------------
Frame: 3226  source=video_file  playback=paused 0:00/0:05
