...
- `.testbed/assets/fixtures/boxing/punch_left/boxing_punch_left_x4_while_guarding_take_01.yaml` — concrete example sidecar
...
- shipped Boxing detector surface is relayed through the provider path:
  ...
  - `weave_left_start` / `weave_left_end`
  - `weave_right_start` / `weave_right_end`
