...
func test_camera_tracking_config_loads_boxing_profile_bundle_from_canonical_paths() -> void:
	...
	assert_true(bool(bundle.get("camera_tracking", {}).get("preview", {}).get("overlays", {}).get("hand_bbox_visible", false)))
	...
	assert_eq(String(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("classifier", {}).get("model", {}).get("artifact_path", "")), "res://addons/aerobeat-input-camera-tracking/docs/baselines/boxing-punch-classifier-frozen-benchmark-mlp-vs-cnn-2026-06-16/mlp/mlp-result.json")
	...
	assert_eq(String(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("prototype_library", {}).get("library_id", "")), "boxing_side_aware_v1")
	assert_eq(int(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("evaluation", {}).get("window_ms", -1)), 250)
	assert_eq(int(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("evaluation", {}).get("window_step_ms", -1)), 33)
	assert_true(is_equal_approx(float(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("thresholds", {}).get("match_score_min", -1.0)), 0.70))
	assert_eq(int(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("timing", {}).get("emit_cooldown_ms", -1)), 250)
	assert_eq(int(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("timing", {}).get("emit_hold_ms", -1)), 100)
	assert_true(bool(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("debug", {}).get("show_scores", false)))
	assert_true(bool(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("prototype", {}).get("debug", {}).get("show_event_gate_state", false)))
	assert_eq(String(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("classifier", {}).get("model", {}).get("artifact_path", "")), "res://addons/aerobeat-input-camera-tracking/docs/baselines/boxing-punch-classifier-frozen-benchmark-mlp-vs-cnn-2026-06-16/mlp/mlp-result.json")
	assert_true(is_equal_approx(float(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("classifier", {}).get("thresholds", {}).get("match_score_min", -1.0)), 0.70))
	assert_eq(int(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("classifier", {}).get("timing", {}).get("emit_cooldown_ms", -1)), 250)
	assert_eq(int(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("classifier", {}).get("timing", {}).get("emit_hold_ms", -1)), 100)
	assert_true(bool(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("classifier", {}).get("debug", {}).get("show_scores", false)))
	assert_true(bool(bundle.get("gesture_detection", {}).get("straight_punch", {}).get("classifier", {}).get("debug", {}).get("show_event_gate_state", false)))
...
func test_camera_tracking_config_switches_to_flow_profile_bundle() -> void:
	...
	assert_true(bool(bundle.get("camera_tracking", {}).get("preview", {}).get("replay", {}).get("enabled", false)))
	assert_true(bool(bundle.get("camera_tracking", {}).get("preview", {}).get("overlays", {}).get("pose_skeleton_visible", false)))
	assert_false(bool(bundle.get("camera_tracking", {}).get("preview", {}).get("overlays", {}).get("hand_bbox_visible", true)))
