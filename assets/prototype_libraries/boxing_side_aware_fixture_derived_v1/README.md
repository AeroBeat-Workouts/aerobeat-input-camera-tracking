...
- Scratch captures: `docs/baselines/prototype-library-derivation-boxing-side-aware-fixture-derived-v1`

## Regenerate

```bash
python3 scripts/derive_prototype_library_from_fixtures.py --manifest .testbed/assets/benchmarks/prototype_matcher_boxing_v1.benchmark.json --output-library-id boxing_side_aware_fixture_derived_v1
```
